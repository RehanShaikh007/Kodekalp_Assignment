  ...
  return (
    <section className="bg-gradient-to-r from-gray-900 to-purple-600 text-white h-screen py-16 px-6">
      <div className="max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
        <h1 className=" text-4xl font-bold md:text-6xl mb-6">Welcome to our</h1>
        <h1 className="text-red-300 flex gap-4 text-4xl font-bold md:text-6xl mb-6 items-center">
          <span>
            <img className="w-20" src="./gmail.png" alt="" />
          </span>
          Gmail
        </h1>
